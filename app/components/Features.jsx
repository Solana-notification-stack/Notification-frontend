        ...
        <div className="relative flex flex-col w-3/4 mx-auto space-y-5">
          <div className="flex flex-col items-center">
            ...
            <h2 className="text-4xl font-bold text-center">
              <span className="block text-white">A better way to build your SaaS</span>
            </h2>
            <p className="text-center text-[#b8b3b3]">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit
            </p>
          </div>
          <div className="flex flex-col py-10 space-x-0 space-y-10 md:space-y-0 md:space-x-5 items-center lg:gap-y-[5rem]">
