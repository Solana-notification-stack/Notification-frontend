...
const LoginForm = () => { 
  ...
  return (
    <>
    <section class="bg-black h-full dark:bg-gray-900">
  <div class="flex bg-black h-full flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
          ...
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <div class="space-y-4 md:space-y-6" action="#">
                  ...
                  <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                      Dont have an account? <a href="/signUp" class="font-medium text-primary-600 hover:underline dark:text-primary-500">Create here</a>
                  </p>
              </div>
          </div>
      </div>
